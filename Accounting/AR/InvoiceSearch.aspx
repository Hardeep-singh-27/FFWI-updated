<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceSearch.aspx.cs" Inherits="Accounting_AR_InvoiceSearch" %><%@ Register assembly="DevExpress.Web.v21.2, Version=21.2.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<!DOCTYPE html>
  ...
  <head runat="server">
    ...
    <script type="text/javascript">
        ...
        function launchCopyModal() {
            //confirms a quote is focused/selected bedore launching modal
            if (filteredQuotesGVCS.GetFocusedRowIndex() > -1) {
                console.log("Running modal launcher");
                csCopyGrid.PerformCallback();
                showHide('copyitemsModal');
                document.getElementById('copyQuoteItems').click();
            } else {
                PopToast("Please select a quote in the grid to copy from");
            }
        }
        ...
        function clickFlipToOrder() {
            document.getElementById('FlipQ').click();
        }

        function clickDeleteQuote() {
            document.getElementById('delQ').click();
        }
    </script>
  </head>
  <body class="body">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <form id="form1" runat="server"><%--defaultbutton="QuoteSearchBtn" defaultfocus="txtQuoteSearch"--%> <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <div id="wholePageHolder" style="display:grid; grid-auto-flow:row; grid-area:site;   transition: margin-left .2s; margin-left:50px;">
          <div class="g-div-header">
            <div class="searchboxRow1-center">
              <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Invoice" CssClass="g-title"></dx:ASPxLabel>
            </div>
            <div class="searchboxRow2-center">
              <dx:ASPxLabel ID="ASPxLabel1" runat="server" CssClass="g-label" Text="Enter search terms to find an invoice. "></dx:ASPxLabel>
            </div>
          </div>
          ...
          <div id="holder" class="searchboxHolder" style="grid-row:3;"><%--Start row 1--%> <div class="searchboxCol1">
              <dx:ASPxLabel ID="ASPxLabel2" CssClass="g-label" runat="server" Text="Invoice Number"></dx:ASPxLabel><%-- Invoice Number --%> <br />
              <dx:ASPxTextBox ID="txtQuoteSearch" runat="server" ClientInstanceName="txtQuoteSearchSC" CssClass="g-textbox">
                <ClientSideEvents Init="function(s, e){s.Focus();}" />
              </dx:ASPxTextBox>
            </div>
            <div class="searchboxCol2"><%-- DATE --%> <dx:ASPxLabel ID="ASPxLabel9" CssClass="g-label" runat="server" Text="Date"></dx:ASPxLabel>
            ...
            <div class="searchboxCol3">
              <dx:ASPxLabel ID="ASPxLabel5" float="left" runat="server" CssClass="g-label" Text="Order Number"></dx:ASPxLabel><%-- Order Number --%> <br />
            ...
            <div class="searchboxCol4"><%-- Bill to Name --%> <dx:ASPxLabel ID="ASPxLabel10" float="left" runat="server" CssClass="g-label" Text="Bill to Name"></dx:ASPxLabel>
              <br />
              <dx:ASPxTextBox ID="txtModelNumberSearch" runat="server" ClientInstanceName="txtModelNumberSearch" CssClass="g-textbox"></dx:ASPxTextBox>
            </div>
            <div class="searchboxCol5"><%-- Salesman --%> <dx:ASPxLabel ID="ASPxLabel16" float="left" runat="server" CssClass="g-label" Text="Salesman"></dx:ASPxLabel>
              <br />
              <dx:ASPxTextBox ID="txtTagSearch" float="left" runat="server" ClientInstanceName="txtTagSearch" CssClass="g-textbox"></dx:ASPxTextBox>
            </div>
            <div class="searchboxCol6">
              <asp:Button ID="InvSearchBtn" runat="server" OnClick="InvSearchBtn_Click" Text="Search" CssClass="g-btn" ToolTip="Search for Invoices" />
              <br />
            </div><%--Start row 2--%><%--  
						<div id="MoreOptions" style="grid-row:2; grid-column:span 5; display:flex; flex-direction:row;">--%> <div class="searchboxCol1Row2"><%-- Office --%> <dx:ASPxLabel ID="ASPxLabel6" runat="server" CssClass="g-label" Text="Office"></dx:ASPxLabel>
              <br />
              <dx:ASPxTextBox ID="ASPxTextBox1" runat="server" ClientInstanceName="txtTagSearch" CssClass="g-textbox"></dx:ASPxTextBox>
            </div>
            ...
            <div id="clearFilters" class="searchboxCol6Row2">
              <asp:Button ID="CreateInvoiceBtn" runat="server" OnClick="CreateInvoiceBtn_Click" Text="Create New Invoice" CssClass="g-btn" ToolTip="Create new invoice" />
          ...
          <div style="grid-row:4;">
            <asp:UpdatePanel ID="searchResults" runat="server" UpdateMode="Conditional">
              <Triggers>
                <asp:AsyncPostBackTrigger ControlID="InvSearchBtn" />
              </Triggers>
              <ContentTemplate>
                <dx:ASPxGridView ID="filteredQuotesGV" runat="server" Font-Names="Helvetica" AutoGenerateColumns="False" ClientInstanceName="filteredQuotesGVCS" KeyboardSupport="true" KeyFieldName="Invoice_Number" CssClass="g-grid" Width="100%" Font-Size="Large" SettingsBehavior-AllowFocusedRow="true">
                  ...
                  <dx:ASPxCallbackPanel ID="callbackPanel" ClientInstanceName="callbackPanel" runat="server" Width="320px" Height="100px" OnCallback="callbackPanel_Callback" RenderMode="Table">
                    <PanelCollection>
                      <dx:PanelContent runat="server">
                        <dx:ASPxGridView ID="quoteDetails" runat="server" AutoGenerateColumns="False" CssClass="g-grid">
                          <Columns>
